...
import userProtoService.UserServiceOuterClass.Metadata;
...
public class GrpcUserService {
        ...
        public boolean isOnFriendList(String userId, String friendId) {
                ...
                Metadata metadata = userStub.isOnFriendList(request).getMetadata();

                if (metadata == null || !metadata.getCode().equals("200")) {
                        throw new RuntimeException("Error checking friend list status: " + metadata.getMessage());
                }
