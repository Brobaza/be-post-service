...
public class KafkaConsumerService {
    ...
    public void listenCreateComment(String message) {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            CreateCommentRequestDto testDto = objectMapper.readValue(message, CreateCommentRequestDto.class);
            System.out.println("CreateCommentRequestDto: " + testDto);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    @KafkaListener(topics = "#{'${spring.kafka.update-comment}'}", groupId = "#{'${spring.kafka.consumer.group-id}'}")
    public void listenUpdateComment(String message) {
        System.out.println("Received message: " + message);
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            UpdateCommentRequestDto testDto = objectMapper.readValue(message, UpdateCommentRequestDto.class);
            System.out.println("UpdateCommentRequestDto: " + testDto);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void listenReactionPost(String message) {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            CreatePostReactionRequestDto testDto = objectMapper.readValue(message, CreatePostReactionRequestDto.class);
            System.out.println("CreatePostReactionRequestDto: " + testDto);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void listenReactionComment(String message) {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            CreateCommentReactionRequestDto testDto = objectMapper.readValue(message, CreateCommentReactionRequestDto.class);
            System.out.println("CreateCommentReactionRequestDto: " + testDto);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
